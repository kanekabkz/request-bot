...
def start(update, context):
    ...
    inline_keyboard = [[InlineKeyboardButton("💬GRUP💬", url = f"{vars.GROUP_LINK}"), InlineKeyboardButton("📢KANAL📢", url = f"{vars.CHANNEL_LINK}")], [InlineKeyboardButton("❗HAKKIMDA❗", callback_data="about")]]
